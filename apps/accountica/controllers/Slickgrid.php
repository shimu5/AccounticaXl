...
class Slickgrid extends CrudeController {
    ...
    public function anonAdd($request, $response) {
        ...
        if ($request->isPost()) {
            try {
                ...
                //$request->data['Customer'] = $request->post;
                
                $request->data['Customer']['usertype'] = $model->usertype;
                $request->data['Customer']['name'] = $request->post['name'];
                $request->data['Customer']['user_name'] = $request->post['user_name'];
                $request->data['Customer']['phone'] = $request->post['phone'];
                $request->data['Account']['opening_balance'] = $request->post['last_balance'];
                $request->data['Account']['cur_id'] = 1;
