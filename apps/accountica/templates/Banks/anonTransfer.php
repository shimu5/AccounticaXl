<?php $this->heading('h1', 'Add Bank Transfer Form') ?>
...
<div class="zform">
    ...
    <div class="fieldset top">
        <div class="ig5">
            <div class="legend">Transfer Form</div>
            <?php echo $this->select('src_bank_id', 'From', array(''=>'select')+$bank_account) ?>
            <?php echo $this->select('dst_bank_id', 'To', array(''=>'select')+$bank_account) ?>
...
<script type="text/javascript">
    ...
    $('#PendingLedger_src_bank_id').change(function(){
