<?php $this->heading('h1', 'Transactions') ?>
...
<div class="index">
    ...
    <div id="inlineFilterPanel" style="display:none;background:#dddddd;padding:3px;color:black;">
        Search Bank name<input type="text" id="txtSearch2">
    </div>
...
<div class="graph">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                title: 'Customer Trasactions Summary',
...
<script type="text/javascript">
    ...
    var columns = [
        ...
        {id: "name", name: "Customer Name", field: "name", editor: Slick.Editors.Text, sortable: true},
        ...
        {id: "branch", name: "Reseller", field: "login", editor: Slick.Editors.Text, sortable: true},
        {id: "server_id", name: "Server", field: "server_id", editor: Slick.Editors.Text, sortable: false},
...
//        {id: "cur_id", name: "Currency", field: "cur_id", editor: Slick.Editors.Text, sortable: true},
    ...
    function myFilter(item, args) {
        ...
        if (args.searchString != "" && item["bank_name"].indexOf(args.searchString) == -1) {
            return false;
        }
